...
{
    public class RemoveProductCarCommandHandler : ICommandHandler<RemoveProductCarCommand, Spg.AutoTeileShop.Domain.Models.Car>
    {
        ...
        public RemoveProductCarCommandHandler(IRepositoryBase<Spg.AutoTeileShop.Domain.Models.Car> repo, IReadOnlyRepositoryBase<Product> repoReadOnly, IReadOnlyRepositoryBase<Domain.Models.Car> repoReadOnlyCar)
        {
            _repo = repo;
